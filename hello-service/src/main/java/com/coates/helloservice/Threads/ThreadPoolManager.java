...
public class ThreadPoolManager implements BeanFactoryAware {
     ...
     */
    Map<String, Object> cachMap = new ConcurrentHashMap<>();
    /**
    ...
    final RejectedExecutionHandler handler = new RejectedExecutionHandler() {
        ...
        public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
            ...
            log.info("系统任务太忙了,把此订单交给(调度线程池)逐一处理，订单号：[{}]", ((BusinessThread) r).getAcceptStr());
        }
    };
    ...
    public void addOrders(String orderId) {
        ...
        //验证当前进入的订单是否已经存在
        if (cachMap.get(orderId) == null) {
            cachMap.put(orderId, new Object());
