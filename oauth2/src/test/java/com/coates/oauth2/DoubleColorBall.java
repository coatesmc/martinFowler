...
public class DoubleColorBall {
    ...
    public static void main(String[] args) {
        //11月29日开奖结果对应序号：
        System.out.println(getBallIndex(2,5,14,24,25,31,9));//12964124
        System.out.println(getBall(12964124));//[6, 20, 28, 29, 30, 31, 12]
        //12月1日开奖结果对应序号：
        System.out.println(getBallIndex(3,11,12,14,17,26,9));//7353378
        System.out.println(getBall(7353378));//[3, 8, 19, 25, 27, 28, 2]
        //12月3日开奖结果对应序号：
        System.out.println(getBallIndex(7,14,22,23,27,30,8));//17009451
        System.out.println(getBall(17009451));//[13, 17, 19, 20, 22, 25, 11]
        System.out.println("预测下次开奖号码,赶快去买吧！");
        System.out.println(getBall(System.nanoTime()));  //[4, 14, 18, 19, 24, 25, 12]
    }
}
