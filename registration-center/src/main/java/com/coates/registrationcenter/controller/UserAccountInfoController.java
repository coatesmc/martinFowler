...
import com.coates.registrationcenter.strategy.AbstractHandler;
import com.coates.registrationcenter.strategy.HandlerContext;
...
import com.coates.tools.util.AccountUtils;
import com.coates.tools.util.MD5Util;
import com.coates.tools.util.RandomUtils;
...
public class UserAccountInfoController {
    ...
    public ApiResult getUserInfo(String type) {
        Map<String, Object> dto = new HashMap<>();
        dto.put("type", type);
        AbstractHandler handler = handlerContext.getInstance(dto.get("type").toString());

        return ApiResult.successInstance().setData(handler.handle(dto));
    }
}
